...
def run_expr(method_list, iteration, PSO_iter, GA_iter, ant_iter, first_stg, second_stg):
    ...
    #set the stored path
    stored_path = '...stored_filepath_here...' 
    ...
    np.save(os.path.join(stored_path,'hc_results.npy'), hc_best_dist)
    ...
    np.save(os.path.join(stored_path,'rw_results.npy'), rw_best_dist)
    #random_walk results
    path_rw = dict()
    ...
    np.save(os.path.join(stored_path,'sa_results.npy'), sa_best_dist)
    #simu_anneal results
    path_sa = dict()
    ...
    np.save(os.path.join(stored_path,'tb_results.npy'), tb_best_dist)
    #tabu_search results
    path_tabu = dict()
    ...
    np.save(os.path.join(stored_path,'PSO_results.npy'), PSO_best_dist)
    #PSO results
    path_PSO = dict()
    ...
    np.save(os.path.join(stored_path,'hyb_results.npy'), hyb_best_dist)
    #hybrid results
    path_hyb = dict()
